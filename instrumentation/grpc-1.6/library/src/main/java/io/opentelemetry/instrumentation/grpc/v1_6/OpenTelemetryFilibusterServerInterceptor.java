...
public class OpenTelemetryFilibusterServerInterceptor implements ServerInterceptor {
  ...
  public <REQUEST, RESPONSE> ServerCall.Listener<REQUEST> interceptCall(
    ...
    logger.log(Level.SEVERE, "SERVICE: " + serviceName + "CMEIK INTERCEPTOR CALLED");
    ...
    try (Scope ignored = context.makeCurrent()) {
      if (shouldInstrument()) {
        ...
        String incomingExecutionIndexDebugString = getExecutionIndexFromMetadata(headers);
        logger.log(Level.SEVERE, "SERVICE: " + serviceName + "CMEIK: " + incomingExecutionIndexDebugString);
        ...
        FilibusterServerInstrumentor filibusterServerInstrumentor = new FilibusterServerInstrumentor(
            ...
            getExecutionIndexFromMetadata(headers),
            contextStorage
        );
